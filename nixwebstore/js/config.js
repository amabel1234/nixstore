const CONFIG = {
nama: "Nixxx Store Yes", // Nama Store
profil: "https://files.catbox.moe/du296e.jpg", // Url Profil
banner: "https://files.catbox.moe/58gojx.jpg", // Url Banner 
tentang: "🌌 Nixx || NixxMbl Store hadir sebagai solusi digital lengkap untukmu! Kami menyediakan Panel Pterodactyl premium untuk game server, bot hosting, hingga web/app hosting dengan performa cepat dan stabil, Jasa design kreatif seperti logo, banner, hingga UI/UX agar bisnismu lebih profesional, serta Script Bot WhatsApp full fitur dengan menu otomatis, AI chat, downloader, payment, dan fitur premium lainnya. Dengan Harga terjangkau, Support 24/7, dan Layanan berkualitas, Nixx || NixxMbl Store adalah pilihan terbaik untuk kebutuhan digitalmu! 🚀✨",
alamat: "Jl. Soekarno, Jakarta, Indonesia",
sosial_media: {
  email: "nix@gmail.com", // Email
  youtube: "@unixxra", // YouTube Username 
  tiktok: "@y", // Tiktok Username 
  whatsapp: "6283182791150", // WhatsApp Number 
  telegram: "@nixcooll" // Telegram Username
},
payment: {
  dana: "083182791150", // Payment Dana
  gopay: "083182791150", // Payment Gopay 
  ovo: "083182791150", // Payment Ovo 
  qris: "https://files.catbox.moe/j3res7.jpg", // Url Qris
  seabank: "083182791150"
},
telegram_api: {
  bot: "7413082692:AAELminA3MnctWgmcXVrv03T_B_2T98hpt8", // Token bot father
  chatid: "7463774265" // ID telegram
},
}
